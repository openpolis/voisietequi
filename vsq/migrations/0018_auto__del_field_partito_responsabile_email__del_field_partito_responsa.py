...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Partito.responsabile_email'
        db.delete_column('vsq_partito', 'responsabile_email')

        # Deleting field 'Partito.responsabile_nome'
        db.delete_column('vsq_partito', 'responsabile_nome')


    def backwards(self, orm):
        # Adding field 'Partito.responsabile_email'
        db.add_column('vsq_partito', 'responsabile_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partito.responsabile_nome'
        db.add_column('vsq_partito', 'responsabile_nome',
    ...
    models = {
        ...
        'vsq.partito': {
            ...
            'sigla': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32'}),
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '60', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'vsq.rispostapartito': {
