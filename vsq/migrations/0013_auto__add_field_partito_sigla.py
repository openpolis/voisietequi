...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partito.sigla'
        db.add_column('vsq_partito', 'sigla',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partito.sigla'
        db.delete_column('vsq_partito', 'sigla')
    ...
    models = {
        ...
        'vsq.partito': {
            ...
            'sigla': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
