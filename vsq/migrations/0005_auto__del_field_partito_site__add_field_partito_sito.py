...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Partito.site'
        db.delete_column('vsq_partito', 'site')

        # Adding field 'Partito.sito'
        db.add_column('vsq_partito', 'sito',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Partito.site'
        db.add_column('vsq_partito', 'site',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Partito.sito'
        db.delete_column('vsq_partito', 'sito')
