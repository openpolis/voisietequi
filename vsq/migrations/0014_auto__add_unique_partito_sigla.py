...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Partito', fields ['sigla']
        db.create_unique('vsq_partito', ['sigla'])


    def backwards(self, orm):
        # Removing unique constraint on 'Partito', fields ['sigla']
        db.delete_unique('vsq_partito', ['sigla'])
