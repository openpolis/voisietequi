...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domanda.slug'
        db.add_column('vsq_domanda', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=60),
                      keep_default=False)

        # Adding field 'Partito.slug'
        db.add_column('vsq_partito', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domanda.slug'
        db.delete_column('vsq_domanda', 'slug')

        # Deleting field 'Partito.slug'
        db.delete_column('vsq_partito', 'slug')
