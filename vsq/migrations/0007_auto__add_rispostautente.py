...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RispostaUtente'
        db.create_table('vsq_rispostautente', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('domanda', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vsq.Domanda'])),
            ('utente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vsq.Utente'])),
            ('risposta_int', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal('vsq', ['RispostaUtente'])


    def backwards(self, orm):
        # Deleting model 'RispostaUtente'
        db.delete_table('vsq_rispostautente')
